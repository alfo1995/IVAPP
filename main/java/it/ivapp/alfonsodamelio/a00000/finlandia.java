...
/**
 * Created by alfonsodamelio on 04/02/17.
 */

public class finlandia extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.finlandia);
